...
| | Current runtime |
| --- | --- |
| Fleet | **120** production-visible and **157** keyed local-development procedural vehicles across **159** saved roster records; **0** GLB-sourced playables |
...
The provenance gate currently reports **130 first-party procedural battle playables, 0 GLB-sourced playables, and 7
...
<tr>
<td width="50%"><img src="public/media/presentation-r1/ui_gallery.webp" alt="Tank Gallery showing a procedural vehicle and technical dossier"><br><sub><b>Tank Gallery:</b> search 120 production vehicles or 157 with the local development fleet enabled, orbit and articulate the current vehicle rig, inspect armor, modules, and crew, and export exact-surface review packets.</sub></td>
